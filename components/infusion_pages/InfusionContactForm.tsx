...
const InfusionContactForm: React.FC = () => {
    ...
    >
      <div className='text-center mb-10'>
        ...
        <h2 className='text-2xl font-bold text-[#101828] mb-2'>
          Let’s plan safe, scalable infusion coverage
        </h2>
        <p className='text-[#667085] text-sm max-w-md mx-auto'>
          Share a few details and we’ll propose a right-sized model (virtual,
          hybrid, or on-site) with a clear compliance plan. day.
        </p>
      </div>
...
export default InfusionContactForm;
